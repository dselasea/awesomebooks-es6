...
**[Awesome book project]** is the main part of javascript project which inluded how to use objects and class. It also includes using es6 modules and webpack
...
```sh
  cd my-folder
  git clone https://github.com/dselasea/awesomebookses6.git
```
...
- Twitter: [@alkhemistjs](https://twitter.com/danielsanyidoho)
